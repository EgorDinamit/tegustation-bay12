/datum/map/terra_vessel
	branch_types = list(
		...
		/datum/mil_branch/worker, // Aliens on the ship
	...
	species_to_branch_blacklist = list(
		...
		/datum/species/machine = list(/datum/mil_branch/terragov, /datum/mil_branch/army, /datum/mil_branch/worker, /datum/mil_branch/alien, /datum/mil_branch/skrell_fleet),
	...
	species_to_branch_whitelist = list(
		/datum/species/diona        = list(/datum/mil_branch/worker),
		/datum/species/nabber       = list(/datum/mil_branch/worker),
		/datum/species/skrell       = list(/datum/mil_branch/civilian, /datum/mil_branch/worker, /datum/mil_branch/skrell_fleet),
		/datum/species/unathi       = list(/datum/mil_branch/worker),
		/datum/species/unathi/yeosa = list(/datum/mil_branch/worker),
		/datum/species/adherent     = list(/datum/mil_branch/worker),
