/datum/job/senior_doctor
	...
	alt_titles = list(
		"Surgeon")
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/senior
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/senior/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/contractor/senior
	)
	allowed_ranks = list(
...
/datum/job/doctor
	...
	alt_titles = list(
		"Paramedic",
		"Corpsman")
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/doctor
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/doctor/fleet,
		/datum/mil_branch/civilian = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/contractor
	)
	allowed_ranks = list(
...
/datum/job/chemist
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/contractor/chemist
...
/datum/job/psychiatrist
	...
	minimal_player_age = 0
	supervisors = "the Chief Medical Officer"
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/counselor
	alt_titles = list(
		"Psychiatrist",
		"Psionic Counselor" = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/counselor/mentalist,
		"Mentalist" = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/counselor/mentalist

	)

	allowed_branches = list(
		/datum/mil_branch/civilian,
		/datum/mil_branch/exploration_division = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/counselor/ed,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/medical/counselor/fleet)
	allowed_ranks = list(
		/datum/mil_rank/civ/contractor,
		/datum/mil_rank/fleet/o1,
		/datum/mil_rank/ed/o1)
