/datum/job/captain
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/command/CO
...
/datum/job/hop
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/command/XO
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/command/XO/fleet
	)
	allowed_ranks = list(
...
/datum/job/rd
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/research/cso
	allowed_branches = list(
		/datum/mil_branch/exploration_division
	)
	allowed_ranks = list(
...
/datum/job/cmo
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/command/cmo
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/command/cmo/fleet
	)
	allowed_ranks = list(
...
/datum/job/chief_engineer
	...
	minimal_player_age = 14
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/command/chief_engineer
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/command/chief_engineer/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ed/o3,
...
/datum/job/hos
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/command/cos
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/command/cos/fleet
	)
	allowed_ranks = list(
		/datum/mil_rank/ed/o3,
		/datum/mil_rank/fleet/o2,
...
/datum/job/representative
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/representative
...
/datum/job/representative/get_description_blurb()
	return "You are the Terran Senator. You are one of the 200 senators that resign in Terran Senate and has been assigned for overseeing the exploration mission on the vessel. You are also responsible for monitoring for any serious missteps of justice, Terran constituion or other ethical or legal issues aboard and informing and advising the Commanding Officer of them. You are also responsible for furthering the vision of your chosen faction, if you are in one."
...
/datum/job/sea
	...
	minimum_character_age = list(SPECIES_HUMAN = 35)
	ideal_character_age = 45
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/command/sea/fleet
	allowed_branches = list(
...
/datum/job/bridgeofficer
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/command/bridgeofficer
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/command/bridgeofficer/fleet
	)
	allowed_ranks = list(
