/datum/job/pathfinder
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/exploration/pathfinder
	allowed_branches = list(/datum/mil_branch/exploration_division)
	allowed_ranks = list(
...
/datum/job/explorer
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/exploration/explorer
	allowed_branches = list(/datum/mil_branch/exploration_division)
