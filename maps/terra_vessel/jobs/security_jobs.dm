/datum/job/warden
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/security/brig_chief
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/security/brig_chief/fleet
	)
	allowed_ranks = list(
...
/datum/job/officer
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/security/officer
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/fleet = /decl/hierarchy/outfit/job/terra_vessel/crew/security/officer/fleet,
	)
	allowed_ranks = list(
