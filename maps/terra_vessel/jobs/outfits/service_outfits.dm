/decl/hierarchy/outfit/job/terra_vessel/crew/service
	l_ear = /obj/item/device/radio/headset/headset_service
	hierarchy_type = /decl/hierarchy/outfit/job/terra_vessel/crew/service

/decl/hierarchy/outfit/job/terra_vessel/crew/service/crewman
	name = OUTFIT_JOB_NAME("Crewman")
	uniform = /obj/item/clothing/under/terragov/utility/exploration
	shoes = /obj/item/clothing/shoes/dutyboots
	id_types = list(/obj/item/card/id/terra_vessel/crew)
	pda_type = /obj/item/modular_computer/pda

/decl/hierarchy/outfit/job/terra_vessel/crew/service/crewman/fleet
	name = OUTFIT_JOB_NAME("Crewman - Fleet")
	uniform = /obj/item/clothing/under/terragov/utility
	shoes = /obj/item/clothing/shoes/dutyboots

/decl/hierarchy/outfit/job/terra_vessel/crew/service/crewman/alien
	name = OUTFIT_JOB_NAME("Crewman - Alien")
	uniform = /obj/item/clothing/under/terragov/utility
	shoes = /obj/item/clothing/shoes/dutyboots

/decl/hierarchy/outfit/job/terra_vessel/crew/service/janitor
	name = OUTFIT_JOB_NAME("Janitor")
	uniform = /obj/item/clothing/under/rank/janitor
	shoes = /obj/item/clothing/shoes/black
	id_types = list(/obj/item/card/id/terra_vessel/crew/service/janitor)
	pda_type = /obj/item/modular_computer/pda

/decl/hierarchy/outfit/job/terra_vessel/crew/service/janitor/ec
	name = OUTFIT_JOB_NAME("Janitor - Exploration Division")
	uniform = /obj/item/clothing/under/terragov/utility/exploration
	shoes = /obj/item/clothing/shoes/dutyboots

/decl/hierarchy/outfit/job/terra_vessel/crew/service/janitor/fleet
	name = OUTFIT_JOB_NAME("Janitor - Fleet")
	uniform = /obj/item/clothing/under/terragov/utility
	shoes = /obj/item/clothing/shoes/dutyboots

/decl/hierarchy/outfit/job/terra_vessel/crew/service/janitor/alien
