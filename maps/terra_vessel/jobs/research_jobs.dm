/datum/job/senior_scientist
	...
	alt_titles = list(
		"Research Supervisor")
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/research/senior_scientist
...
/datum/job/scientist
	...
	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/research/scientist
	allowed_branches = list(
	...
	allowed_ranks = list(
		/datum/mil_rank/ed/o1,
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/terra_vessel/passenger/research/scientist,
		/datum/mil_rank/terragov/scientist = /decl/hierarchy/outfit/job/terra_vessel/passenger/research/scientist/terragov
	)
...
/datum/job/scientist_assistant
	...
	alt_titles = list(
		"Custodian" = /decl/hierarchy/outfit/job/terra_vessel/passenger/research/assist/janitor,
		"Testing Assistant" = /decl/hierarchy/outfit/job/terra_vessel/passenger/research/assist/testsubject,
		"Intern",
		"Clerk",
		"Field Assistant")

	outfit_type = /decl/hierarchy/outfit/job/terra_vessel/crew/research
	allowed_branches = list(
		/datum/mil_branch/exploration_division,
		/datum/mil_branch/civilian,
		/datum/mil_branch/terragov
	...
	allowed_ranks = list(
		...
		/datum/mil_rank/civ/contractor = /decl/hierarchy/outfit/job/terra_vessel/passenger/research/assist,
		/datum/mil_rank/terragov/scientist = /decl/hierarchy/outfit/job/terra_vessel/passenger/research/assist/terragov
	)
	max_skill = list(   SKILL_ANATOMY     = SKILL_MAX,
	                    SKILL_DEVICES     = SKILL_MAX,
	                    SKILL_SCIENCE     = SKILL_MAX)
