...
/datum/preferences/proc/update_preview_icon()
	...
	preview_icon.Scale(48+32, 16+32+16) //old values were (48+32, 16+32), adding another +16 on the Y axis to fit some taller species
	...
	preview_icon.Scale(preview_icon.Width() * 4, preview_icon.Height() * 4) // Scaling here to prevent blurring in the browser. //older scaling values were 2 instead of 4
